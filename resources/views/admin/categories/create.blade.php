...
<body class="bg-gray-100 p-8">
    <div class="container mx-auto bg-white p-6 rounded-lg shadow-lg max-w-lg">
        <h1 class="text-3xl font-bold mb-4">Tambah Kategori Baru</h1>
        ...
        <form action="{{ route('admin.categories.store') }}" method="POST">
            ...
            <div>
                <button type="submit" class="w-full bg-green-500 text-white py-2 rounded-lg">Simpan Kategori</button>
            </div>
        </form>
    </div>
</body>
